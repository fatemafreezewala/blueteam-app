...
const AdditionalService = ({route,navigation}) => {
    ...
    const onRoute = ()=>{
      if(selectedid != ''){
        ...
        var url = 'https://admin.blueteam.xyz/payforcredit.php?name='+user.name+'&id='+id+'&email='+user.email+'&number='+user.phone+'&amount='+total+'&mid='+selectedid+'&getamt='+buyamount+'&customer_id='+user.customer_tap_id;
        console.log(url)
        navigation.navigate('Payment',{url:'https://admin.blueteam.xyz/payforcredit.php?name='+user.name+'&id='+id+'&email='+user.email+'&number='+user.phone+'&amount='+total+'&mid='+selectedid+'&getamt='+buyamount+'&customer_id='+user.customer_tap_id})
