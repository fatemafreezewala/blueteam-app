   ...
   if(imgArray.length > 0){
    ...
    if(ifavai == 'online_booking'){
      navigation.navigate('PaymentBooking',{
        url:'https://admin.blueteam.xyz/gosell123.php?name='+name+'&main_id='+bid+'&id='+booking_id+'&email='+email+'&number='+phone+'&amount='+price+'&booking_id='+booking_id+'&customer_id='+customer_tap_id ,
