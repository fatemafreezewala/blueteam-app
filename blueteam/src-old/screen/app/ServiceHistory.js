        ...
        <View style={{flex:1,backgroundColor:'#fff'}}>
            ...
            showsVerticalScrollIndicator={false}
              ...
              renderItem={({item})=>(<View key={item.id} style={styles.notobox}>
                  ...
                  {showcancel == true && (<View style={{flexDirection:'row',justifyContent:'flex-end'}}>
                    <TouchableOpacity onPress={()=>{cancelBooking(item.id)}}><Text style={{color:'#ff5656'}}>Cancel</Text></TouchableOpacity>
                  </View>)}
              </View>)}
