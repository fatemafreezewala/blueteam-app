                ...
                if(finalArry.category_id == '3'){
                  ...
                  if(ifavai == 'online_booking'){
                    navigation.navigate('PaymentBooking',{
                      url:'https://admin.blueteam.xyz/gosell123.php?name='+name+'&main_id='+response.data.data.bid+'&id='+response.data.data.service_id+'&email='+email+'&number='+phone+'&amount='+bookdata.price+'&booking_id='+response.data.service_id+'&customer_id='+user.customer_tap_id ,
                      booking_id:response.data.data.service_id,
                      date:response.data.data.prefered_date,
                      time:response.data.data.time_zone,
                      phone:response.data.data.phone,
